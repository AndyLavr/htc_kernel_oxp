...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_ONDEMAND_2_PHASE)
extern struct cpufreq_governor cpufreq_gov_ondemand_2_phase;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_ondemand_2_phase)
